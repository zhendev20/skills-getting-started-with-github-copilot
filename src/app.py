...
activities = {
    ...
    "Soccer Club": {
        "description": "Build teamwork and improve soccer skills",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["liam@mergington.edu", "noah@mergington.edu"]
    },
    "Basketball Team": {
        "description": "Practice basketball drills and compete in games",
    ...
    "Drama Club": {
        "description": "Act, perform, and develop stage skills",
    ...
    "Science Club": {
        "description": "Discover science through experiments and projects",
